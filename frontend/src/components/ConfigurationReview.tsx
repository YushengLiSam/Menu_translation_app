...
import type { ConfigurationData } from './ConfiguratorWizard';
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className={`w-20 h-20 rounded-full flex items-center justify-center ${compatibilityScore === 100 ? 'bg-green-100' : 'bg-amber-100'
                  }`}>
